...
const App = () => {
  ...
  const getDataFromAirtable = async () => {
    try {
      const config = {
        headers : {
          Authorization: "Bearer keyQY6e1Zkg9l7ktx",
        },
      };
      ...
      const response = await axios.get(
        "https://api.airtable.com/v0/appYWUShayjHVLDrD/Table%201?maxRecords=100&view=Grid%20view",
        config
        );
  ...
  const addData = async (newData) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://api.airtable.com/v0/appYWUShayjHVLDrD/Table%201", 
        sendData, 
        config
      );
  ...
  const removeData = async (id) => {
    ...
    try {
      ...
      const axiosParams = {
        method: "delete",
        url: `https://api.airtable.com/v0/appYWUShayjHVLDrD/Table%201/${id}`,
        headers: {
          Authorization: "Bearer keyQY6e1Zkg9l7ktx",
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="d-flex justify-content-center align-item-center" style={{
      ...
      <div className="container text-white">
          ...
          <h2 className="text-center mb-4">Agus Setiono</h2>
          <div className="d-flex justify-content-center align-item-center">
          <img src="/image.svg" alt="just-gambar" style={{
