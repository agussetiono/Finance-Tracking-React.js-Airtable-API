...
const List = (props) => {
    ...
    return <div className={` col-4 bg-${props.bg} px-3 py-3 `}
        style={{
            borderRadius: "5px",
        }}
        >
    
    <h2 className="text-white text-center">{props.type === "expense" ? "Pengeluaran" : "Pemasukan"}</h2>
    {props.Loading ? <Loading/> : <><h4 className="text-center text-white">
